    ...
    <div className="relative">
      <div className="flex items-center justify-center relative">
        <button
          ...
          className="absolute w-50 h-full z-50 left-0 p-5"
        >
        ...
        >
          ...
          <div
            className="flex relative transition-transform ease-in-out duration-500"
          ...
          >
            {carouselData.map((image, index) => (
              <img
                key={index}
                src={image}
                className="h-full w-full object-cover relative bottom-12"
                alt={`Slide ${index}`}
              />
            ))}
          </div>
        ...
        <button
          ...
          className="absolute w-50 h-full z-50 right-0 p-5 "
        >
